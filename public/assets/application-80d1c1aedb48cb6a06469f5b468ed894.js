...
(function() {
  ...
  isItCool.controller("MainCtrl", [
    "$scope", "$http", "$rootScope", function($scope, $http, $rootScope) {
      if (!$scope.current_user) {
        console.log("checking for current_user");
        return $http.get("/logged_in_user.json").success((function(_this) {
  ...
  isItCool.controller("siteCtrl", [
    "$scope", "$http", "$rootScope", "$location", function($scope, $http, $rootScope, $location) {
      ...
      $scope.reviews = [];
      $scope.review = {};
      $scope.addSession = function(loginUser) {
        console.log("hi");
        ...
        return $http.post("/login.json", {
          ...
          return $scope.signInErr = true;
        }).error(function(err) {
          return $scope.signInErr = false;
        });
      };
      $scope.checkSesh = function() {
        return $http.get("/logged_in_user.json").success(function(user) {
          console.log(user);
          $rootScope.current_user = user;
          return $scope.userActive(user);
        });
      };
      $scope.userActive = function(user) {
        ...
        return $scope.searchBox = true;
      };
      $scope.checkSesh();
      $scope.logout = function() {
        return $http.get("/logout.json").success(function() {
          ...
          $scope.searchBox = true;
          $scope.addEventBox = false;
          return $scope.usernameNav = false;
        });
      };
      $scope.clearSearch = (function(_this) {
        return function() {
          return $scope.query = "";
        };
      })(this);
      $scope.getReviews = function(event) {
        ...
        return $http.get("/events/" + event.id + "/reviews.json").success(function(data) {
          return $scope.reviews = data;
        });
      };
      $scope.addReview = function(review, index) {
        review.event_id = index;
        return $http.post("/events/" + index + "/reviews.json", {
          review: review
      ...
      $scope.signUp = function(newUser) {
        ...
        return $http.post("/users.json", {
          ...
          return function(data) {
            ...
            return $scope.show_sign_in = true;
          };
        })(this)).error(function(err) {
          return $scope.signUpErr = false;
        });
      };
      ...
      $scope.newEvent = function(event) {
        console.log(event);
        return $http.post("/events.json", event).success((function(_this) {
          return function(data) {
            $scope.event = "";
            $scope.events.push(data);
            console.log(data);
            return $scope.eventErr = true;
          };
        })(this)).error(function(err) {
          return $scope.eventErr = false;
        });
      };
      $scope.editEvent = function(event, index) {
        ...
        console.log(index);
        return $http.put("/events/" + index + ".json", event).success((function(_this) {
          return function(data) {
            console.log(data);
            _this.event = data;
            return _this.show_event_edit = false;
          };
        })(this));
      };
      $scope.deleteEvent = function(id, index) {
        console.log(index);
        return $http["delete"]("/events/" + id + ".json").success((function(_this) {
          return function(data) {
      ...
      $scope.showSearch = function() {
        ...
        $scope.authBox = false;
        $scope.addEventBox = false;
        return console.log("show Search");
      };
      $scope.showAuthBox = function() {
        $scope.authBox = true;
        $scope.searchBox = false;
        $scope.addEventBox = false;
        return console.log("show Auth");
      };
      $scope.showAddEvent = function() {
        $scope.addEventBox = true;
        $scope.searchBox = false;
        $scope.authBox = false;
        return console.log("show Event");
      };
      $scope.editEventShow = function() {
        return this.show_event_edit = true;
      };
      $scope.hideReviews = function() {
        return this.show_reviews = false;
      };
      $scope.showReviewForm = function() {
        return $scope.show_review_form = true;
      };
      $scope.showSignUp = function() {
        $scope.show_sign_up = true;
        return $scope.show_sign_in = false;
      };
